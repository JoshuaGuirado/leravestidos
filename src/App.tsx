        ...
        <div className="max-w-7xl mx-auto px-6 h-28 flex items-center justify-between">
          <div className="flex items-center gap-6 group cursor-pointer" onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})}>
            <div className="relative">
              <img src="/assets/logo.png" alt="Milchukova Bridal Logo" className="w-24 h-24 object-contain transition-transform group-hover:scale-105 mix-blend-multiply" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
            ...
            >
              ...
              <div className="pt-8">
                 ...
                 <img src="/assets/logo.png" alt="Logo M" className="w-40 h-40 object-contain filter invert mix-blend-screen" />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <footer className="bg-paper border-t border-ink/5 py-24">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-12">
          <div className="flex flex-col items-center gap-6">
             <img src="/assets/logo.png" alt="Logo Footer" className="w-40 h-40 object-contain mix-blend-multiply" />
          </div>
